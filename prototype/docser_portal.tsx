                ...
                <aside className="lg:w-64 flex-shrink-0">
                  <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-6 shadow-xs">
                    ...
                    <div className="text-center pb-4 border-b border-slate-100">
                      ...
                      <p className="text-xs text-teal-600 font-semibold">{loggedInDoctor?.specialty} • {loggedInDoctor?.role}</p>
                      ...
                      <div className="mt-3 pt-2 border-t border-dotted border-slate-100">
                        ...
                        <select 
                          ...
                          className="text-xs p-1 bg-slate-50 border border-slate-200 rounded-md w-full focus:ring-1 focus:ring-teal-500 text-slate-700 font-medium"
                        >
                          {doctors.map(d => (
                    ...
                    <nav className="space-y-1">
                      <button
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                          activeTab === 'doctor-dashboard' ? 'bg-teal-600 text-white' : 'text-slate-600 hover:bg-slate-50'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                          ...
                          activeTab === 'planner' ? 'bg-teal-600 text-white' : 'text-slate-600 hover:bg-slate-50'
                        }`}
                      >
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                          loggedInDoctor?.status !== 'Approved' ? 'opacity-50 cursor-not-allowed text-slate-400' :
                          activeTab === 'locations' ? 'bg-teal-600 text-white' : 'text-slate-600 hover:bg-slate-50'
                        }`}
                      >
                        <div className="flex items-center space-x-3">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                          activeTab === 'registration' ? 'bg-teal-600 text-white' : 'text-slate-600 hover:bg-slate-50'
                        }`}
                      >
...
function AdminLogin({ onLogin }) {
  const [email, setEmail] = useState('admin@docser.org');
  ...
  return (
    <div className="max-w-md w-full bg-white rounded-2xl border border-slate-200 shadow-xl p-8 space-y-6">
      ...
      <div className="space-y-4 text-xs">
          ...
          <div className="space-y-2">
            {doctors.map(doc => (
              <button
                ...
                className="w-full p-3 border rounded-xl hover:border-teal-500 hover:bg-teal-50/30 text-left transition-all flex items-center justify-between"
              >
                <div className="flex items-center space-x-3">
        ...
        <button 
          onClick={onSignUp}
          className="w-full py-3 bg-teal-600 hover:bg-teal-700 text-white font-bold uppercase rounded-xl shadow-md transition-colors text-center block"
        >
...
function LandingPage({ camps, doctors, onJoinCTA, onAdminCTA }) {
  return (
    <div className="bg-slate-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-teal-900 via-teal-800 to-slate-900 text-white py-20 px-4 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            <button 
              onClick={onJoinCTA}
              className="w-full sm:w-auto px-8 py-4 rounded-xl bg-teal-500 text-slate-900 font-bold hover:bg-teal-400 transition-all shadow-lg hover:scale-105 active:scale-95 text-sm"
            >
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleFormSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200 text-center">
              ...
              {uploadProgress.degree === 0 ? (
                <button 
                  ...
                  className="px-4 py-1.5 rounded-lg bg-slate-100 hover:bg-teal-50 hover:text-teal-700 text-xs font-semibold text-slate-600 transition-colors"
                >
                  Upload File
                </button>
              ) : (
                <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                  <div className="bg-teal-500 h-full transition-all" style={{ width: `${uploadProgress.degree}%` }}></div>
                </div>
              )}
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200 text-center">
              ...
              {uploadProgress.license === 0 ? (
                ...
                <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                  <div className="bg-teal-500 h-full transition-all" style={{ width: `${uploadProgress.license}%` }}></div>
                </div>
              )}
        ...
        <div className="flex justify-end space-x-3 pt-2">
          <button 
            type="submit"
            className="px-6 py-3 bg-teal-600 text-white font-bold text-xs uppercase tracking-wider rounded-xl shadow-lg hover:bg-teal-700 transition-colors"
          >
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-lg w-full p-6 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 bg-teal-50 border border-teal-100 rounded-xl flex items-center space-x-3">
                ...
                <div>
                  <p className="font-bold text-teal-900">National Practitioner Roster Verified</p>
                  <p className="text-teal-800">Licensing status confirmed through centralized medical database matching.</p>
                </div>
              </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-teal-50 to-teal-100/50 p-5 rounded-2xl border border-teal-100 space-y-1">
          <span className="text-xs font-semibold text-teal-800 uppercase tracking-wider block">Target Commits</span>
          <div className="flex items-baseline space-x-1.5">
            <span className="text-3xl font-black text-teal-900">{doctor?.committedDays}</span>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-r from-teal-50 to-teal-100/30 border border-teal-200 rounded-xl p-4 text-xs space-y-3 shadow-xs">
          <div className="flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <div className="flex items-end">
              <button
                ...
                className="w-full py-2 bg-teal-600 hover:bg-teal-700 text-white font-bold rounded shadow-xs uppercase tracking-wide text-[10px]"
              >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-2.5 py-1 text-[10px] font-bold uppercase rounded bg-teal-50 text-teal-700 hover:bg-teal-100 border border-teal-200 transition-colors"
              >
                📅 Choose All Days
              </button>
              <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <button 
            ...
            className="w-full py-3 bg-teal-600 text-white text-xs font-bold uppercase tracking-wider rounded-xl hover:bg-teal-700 transition-colors shadow-lg"
          >
...
function DoctorDashboard({ doctor, camps, invitations, setInvitations, triggerToast }) {
  ...
  return (
    <div className="space-y-8">
        ...
        {doctor?.status !== 'Approved' ? (
          ...
          <div className="space-y-3">
            {activeInvitations.map(inv => {
              ...
              return (
                <div key={inv.id} className="p-5 bg-white border border-slate-200 rounded-2xl shadow-xs hover:border-teal-300 transition-all flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-xs">
                  <div className="space-y-1 flex-1">
                    <div className="flex items-center space-x-2">
                      <span className="bg-teal-100 text-teal-800 font-bold text-[10px] px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                        {camp.location} Camp
                      </span>
                    ...
                    {inv.status === 'Pending' ? (
                      <>
                        <button 
                          ...
                          className="px-4 py-2 bg-teal-600 text-white font-bold rounded-xl shadow-xs hover:bg-teal-700 transition-colors"
                        >
                          Accept Invite
                        </button>
                        <button 
      ...
      <div className="bg-gradient-to-r from-teal-900 to-slate-900 text-white p-6 rounded-2xl shadow-xl flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            <div>
              ...
              <input 
                ...
                value={formData.date}
                onChange={handleChange}
                className="w-full p-2.5 bg-white border border-slate-300 rounded-lg focus:ring-1 focus:ring-teal-500 focus:outline-none"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input 
                ...
                onChange={handleChange}
                className="w-full text-xs p-2.5 bg-white border border-slate-300 rounded-lg focus:ring-1 focus:ring-teal-500"
              />
            </div>
            <div>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 text-xs">
        ...
        <select 
          ...
          className="p-1.5 px-2 border border-slate-300 rounded bg-white font-semibold focus:ring-1 focus:ring-teal-500 text-slate-800"
        >
          {camps.map(c => (
                          ...
                          <td className="p-4 text-right">
                            <button
                              ...
                              className={`px-3 py-1.5 rounded-lg text-xs font-bold text-white transition-all ${
                                !attendance ? 'bg-teal-600 hover:bg-teal-700' :
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-4">
          ...
          <div className="space-y-3 pt-2">
            {[
              { label: 'General Medicine & Family Clinic', count: 48, color: 'bg-teal-600' },
