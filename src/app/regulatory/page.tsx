    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans antialiased flex flex-col">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 flex-1 space-y-12">
        <div className="space-y-4">
          <span className="bg-teal-500/10 text-teal-400 font-mono text-[10px] uppercase tracking-widest px-3 py-1 rounded-full border border-teal-500/20">
          ...
          <p className="text-slate-400 text-sm leading-relaxed max-w-2xl">
            DocSer operates in strict compliance with public healthcare directives and licensing guidelines. All practitioners onboarded are audited for active clinical credentials.
          </p>
        </div>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-6 text-center text-slate-500 text-xs mt-auto">
        <p>© 2026 DocSer. Regulatory Compliance Platform.</p>
      </footer>
    </div>
  );
}
