  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans antialiased flex flex-col">
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 flex-1 space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-sm leading-relaxed max-w-2xl">
            Avodah values the privacy of medical practitioners and volunteers. Our principles guide how we collect, store, and utilize credentialing and operational metrics securely.
          </p>
        </div>
        ...
        <div className="p-6 bg-emerald-950/20 border border-emerald-900/30 rounded-2xl space-y-2">
          ...
          <p className="text-slate-400 text-xs leading-relaxed">
            Avodah connects medical practitioners with community organizers. We enforce GDPR and HIPAA data handling practices. No patient medical records are stored on our servers; we only store campaign operational metrics.
          </p>
        </div>
      </main>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-6 text-center text-slate-500 text-xs mt-auto">
        <p>© 2026 Avodah. Privacy First Platform.</p>
      </footer>
    </div>
  );
}
