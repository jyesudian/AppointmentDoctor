  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans antialiased flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <Link href="/" className="flex items-center space-x-3 cursor-pointer">
              <div className="w-10 h-10 rounded-xl bg-teal-600 flex items-center justify-center text-white font-bold shadow-md shadow-teal-100/10">
              ...
              <span className="text-xl font-extrabold tracking-tight text-white">DocSer</span>
            </Link>
      ...
      <main className="max-w-4xl mx-auto px-4 py-16 flex-1 space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-sm leading-relaxed max-w-2xl">
            DocSer values the privacy of medical practitioners and volunteers. Our principles guide how we collect, store, and utilize credentialing and operational metrics securely.
          </p>
        </div>
        ...
        <div className="p-6 bg-emerald-950/20 border border-emerald-900/30 rounded-2xl space-y-2">
          ...
          <p className="text-slate-400 text-xs leading-relaxed">
            DocSer connects medical practitioners with community organizers. We enforce GDPR and HIPAA data handling practices. No patient medical records are stored on our servers; we only store campaign operational metrics.
          </p>
        </div>
      </main>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-6 text-center text-slate-500 text-xs mt-auto">
        <p>© 2026 DocSer. Privacy First Platform.</p>
      </footer>
    </div>
  );
}
